...
class AgentFlowClient:
    """
    Client for interacting with a version-aware Agent Flow Server.
    ...
    def __init__(self, endpoint: str, poll_interval: float = 5.0, timeout: float = 20.0):
        """Initializes the AgentFlowClient.

        Args:
            endpoint: The root URL of the Agent Flow server.
        ...
        self._default_headers = {"X-AgentFlow-Client": "true"}
...
class DevTaskLoader(AgentFlowClient):
    ...
    a full Agent Flow server is not needed.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Additional arguments passed to the parent AgentFlowClient.
        """
